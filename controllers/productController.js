...
// Función que lee el array de platos    
  readAll : (req, res) => 
    res.render('index', { about: aboutC, menu: listaPlatosC}),
// Función que busca un plato según el Id
  readDetail :  (req, res) => {
    
    let platoC = listaPlatosC.find(plato => plato.id == req.params.menuId)

    res.render("detalle", { plato: platoC })
